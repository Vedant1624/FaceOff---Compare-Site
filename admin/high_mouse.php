...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_product"])) {
    ...
    $sql = "INSERT INTO highmouse (Id, Name, Price, Min_dpi, Max_dpi, dpi, PollingRate, Connectivity, Wireless, Warranty, Buttons, SideButtons, Software, Orientation, Weight, Rgb, CableType, CableLength, Length, Width, Height,Url)
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>window.location.href='flagship_mouse.php'; alert('Record Added Successfully')</script>";
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update_product"])) {
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        echo "<script>window.location.href='flagship_mouse.php'; alert('Record updated Successfully')</script>";
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
    }
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete_product"])) {
    ...
    $sql = "DELETE FROM highmouse WHERE Id = '$productIdToDelete'";

    // Execute the delete query
    if ($conn->query($sql) === TRUE) {
        echo "<script>window.location.href='flagship_mouse.php'; alert('Record Deleted Successfully')</script>";
    } else {
        echo "Error: " . $sql . "<br>" . $conn->error;
    }
}
...
<body>
    <section>
        <h1>Admin Panel | FlagShip Mouse</h1>
