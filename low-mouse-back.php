...
<head>
    ...
    <title>Budget Mouse Comparison</title>
    ...
    `;
        ...
        function item1(a) {
            ...
            if (a != select2) {
                ...
                document.getElementById("Length1").innerHTML = productData[a].Length + "mm"
                document.getElementById("Width1").innerHTML = productData[a].Width + "mm"
                document.getElementById("Height1").innerHTML = productData[a].Height + "mm"
        ...
        function item2(a) {
            ...
            if (a != select1) {
                ...
                document.getElementById("Length2").innerHTML = productData[a].Length + "mm"
                document.getElementById("Width2").innerHTML = productData[a].Width + "mm"
                document.getElementById("Height2").innerHTML = productData[a].Height + "mm"
