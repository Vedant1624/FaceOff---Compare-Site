...
<body class="cont">
    ...
    <div class="container">
        <div>
            <table class="table">
                ...
                <tr>
                    <th>No of Anti-Ghosting Keys</th>
                    <td id="NoAntiGhosting1">N/A</td>
                    <td id="NoAntiGhosting2">N/A</td>
                </tr>
                <tr>
                    <th>CableLength</th>
    ...
    while ($row = $result->fetch_assoc()) {
        $product = [
            ...
            "NoAntiGhosting" => $row["NoAntiGhosting"],
    ...
    `;
        ...
        function item1(a) {
            ...
            if (a != select2) {
                ...
                document.getElementById("NoAntiGhosting1").innerHTML = productData[a].NoAntiGhosting
                ...
                document.getElementById("NoAntiGhosting1").innerHTML = ""
        ...
        function item2(a) {
            ...
            if (a != select1) {
                ...
                document.getElementById("NoAntiGhosting2").innerHTML = productData[a].NoAntiGhosting
                ...
                document.getElementById("AntiGhosting2").innerHTML = ""
